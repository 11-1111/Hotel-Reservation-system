  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    if($chk_avail['checkin']!='' && $chk_avail['checkout']!='')
    {
      ...
      if($checkin_date == $checkout_date){
        echo"<h3 class='text-center text-danger'>Invalid Dates! You cant check-out same day of check-in</h3>";
        exit;
      }
    ...
    //count no of rooms and output to store room cards
    $count_rooms = 0;
    $output = "";
  
    //fetching settings to check shutdown is set or not
