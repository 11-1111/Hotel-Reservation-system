<div class="container-fluid bg-white mt-5">
   <div class="row">
      ...
      <div class="col-lg-4 p-4">
         ...
         <a href="facilities.php" class="d-inline-block mb-2 text-dark text-decoration-none">Faciities</a> <br>
...
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by <span style="color:red;">Goko Ivy<span></h6>
