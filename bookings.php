...
<html lang="en">
 <head>
    ...
    <title>CAANAN HOTEL-BOOKINGS</title>
  ...
  <body class="bg-light">
    ...
    <?php
      ...
      if(isset($_GET['cancel_status'])){
        ...
        alert('success','Thank you for Review and Rating');
      }
    ?>
    ...
    {
      if(confirm('Are you sure to cancel this boooking?'))
      {
