...
<html lang="en">
 <head>
    ...
    <title>CAANAN HOTEL-PROFILE</title>
            ...
            <form id="info-form">
              ...
              <div class="row">
                ...
                <div class="col-md-8 mb-4">
                  ...
                  <textarea name="address" type="text" class="form-control shadow-none" rows="1" required><?php echo $u_fetch['address']  ?></textarea>
                </div>
              </div>
            ...
            <form id="pass-form">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input name="new_pass" id="new_pass" type="password" class="form-control shadow-none" required autocomplete="current-password">
                </div> 
                <div class="col-md-6 mb-4">
                  <label class="form-label">Confirm Password</label>
                  <input name="confirm_pass" id="confirm_pass" type="password" class="form-control shadow-none" required autocomplete="current-password">
                </div>
              </div>
              <button type="submit" class="btn text-white custom-bg shadow-none">Save Changes </button>
            </form>
      ...
      profile_form.addEventListener('submit',function(e){
        ...
        xhr.onload = function(){
          if(this.responseText == 'inv_img'){
            alert('error',"Only jpeg, png, jpg and webp images are allowed!");
          }
