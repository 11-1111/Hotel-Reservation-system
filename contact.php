...
<html lang="en">
 <head>
    ...
    <title>CAANAN HOTEL-CONTACT</title>
  ...
  <body class="bg-light">
    ...
    <div class="my-5 px-4">
      ...
      we can help. our team is on hand working to get to your concern
      </p>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 mb-5 px-4">
          <div class="bg-white rounded shadow p-4">
            ...
            <a href="mailto:gokoivy2@gmail.com" class="d-inline-block mb-2 text-decoration-none text-dark">
    <i class="bi bi-envelope-fill"></i> gokoivy2@gmail.com
</a>
