  ...
  if(isset($_POST['get_all_rooms']))
  {
    ...
    while($row = mysqli_fetch_assoc($res))
    {
      ...
      <tr class='align-middle'>
       ...
       <td>$status</td>
       <td>
          <button onclick='edit_details($row[id])' type='button' class='btn btn-primary shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#edit-room'>
          <i class='bi bi-pencil-square'></i>
          </button>
          <button onclick=\"room_images($row[id],'$row[name]')\" type='button' class='btn btn-info shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#room-images'>
          <i class='bi bi-images'></i>
          </button>
          <button onclick='remove_room($row[id])' type='button' class='btn btn-danger shadow-none'>
